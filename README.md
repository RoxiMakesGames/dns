...
> DNS management — record configuration, filtering, and resolution
...
sovctl package install dns

# Manual — Kubernetes
kubectl apply -k k8s/

# Manual — Docker Compose
docker compose -f docker-compose.yaml -f packages/dns/docker/compose.yaml up -d
```
